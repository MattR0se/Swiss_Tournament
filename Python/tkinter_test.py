...
class Window(tk.Frame):
    ...
    def init_window(self):
        ...
        self.editmenu.add_command(label='Edit Players', command=self.editPlayer, 
                                  state='disabled')
        self.editmenu.add_command(label='Remove Players', state='disabled')
        self.editmenu.add_command(label='Edit Results', state='disabled')
...
class popupResult():
    def __init__(self, window, master):
        ...
        default = choices[0]
        popupMenu = ttk.OptionMenu(top, self.table, default, *choices, command=self.setName)
        popupMenu.pack()
        self.player1, self.player2 = tk.StringVar(), tk.StringVar()
        self.setName(default)
        self.l1 = tk.Label(top, text='Wins for:')
        self.l1.pack()
        self.l12 = tk.Label(top, textvariable=self.player1)
        self.l12.pack()
        self.e1 = tk.Entry(top)
        self.e1.pack()
